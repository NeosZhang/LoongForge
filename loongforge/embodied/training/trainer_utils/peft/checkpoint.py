...
from training.trainer_utils.peft.injector import _detect_vlm_interface, _VLM_ATTR_CANDIDATES
    ...
    for target in search_targets:
        for attr in _VLM_ATTR_CANDIDATES:
            if hasattr(target, attr):
                ...
                # Also include architecture prefix
...
def save_lora_checkpoint(
    *,
    ...
    vlm_module = None
    if hasattr(cfg, "lora"):
        vlm_module = getattr(cfg.lora, "vlm_module", None)
