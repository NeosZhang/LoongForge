"""
Action Space Registry and Implementations

Provides action space definitions for different robot control modalities:
- EE6D: End-effector position (xyz), 6D rotation, and gripper
- Joint: Joint space with gripper
- Auto: Auto-detecting action dimension
- FrankaJoint7: Franka Panda 7-joint arm
- BimanualSO101: Dual-arm SO101 robot
"""
...
class BaseActionSpace(nn.Module):
    ...
    def compute_loss(self, pred: torch.Tensor, target: torch.Tensor) -> dict[str, torch.Tensor]:
        """Compute supervised loss between prediction and target; must be implemented by subclasses."""
