...
Configuration classes for Florence-2 vision-language model backbone.
Includes vision config (DAViT encoder), language config (BART), and combined config.
"""
import warnings
...
class Florence2VisionConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Florence2VisionModel`].
    It is used to instantiate a Florence2VisionModel
...
class Florence2LanguageConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Florence2LanguagePreTrainedModel`].
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 51289):
            Vocabulary size of the Florence2Language model. Defines the number of different tokens that can be
            represented by the
...
class Florence2Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Florence2ForConditionalGeneration`].
