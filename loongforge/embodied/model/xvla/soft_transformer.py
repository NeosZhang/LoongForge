"""
Soft-Prompted Domain-Aware Transformer

Multi-modal transformer backbone with:
- Domain-conditioned linear layers
- Optional soft prompts per domain
- Temporal, proprioceptive, and action token encoding
...
class Mlp(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Apply MLP: fc1 -> act -> drop -> norm -> fc2 -> drop."""
