...
from loongforge.embodied.data.transforms.groot_n1_6.eagle3_model.image_processing_eagle3_vl_fast import (
    Eagle3VLImageProcessorFast,
)
from loongforge.embodied.data.transforms.groot_n1_6.eagle3_model.processing_eagle3_vl import (
    Eagle3VLProcessor,
)
from .utils import (
...
class Gr00tN1d6Processor:
    ...
    def __init__(
        ...
        self.model_name = model_name
        self.vlm_tokenizer_path = vlm_tokenizer_path
        self.model_type = model_type
        ...
        self._collator = self.data_collator_class(
            ...
            vlm_tokenizer_path=vlm_tokenizer_path,
