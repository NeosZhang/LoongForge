...
def add_training_args(parser: argparse.ArgumentParser):
    ...
    g.add_argument("--lr-group", type=str, default=None,
                   help="Per-module LR overrides in 'module.path=lr' format, "
                        "comma-separated. Processed before --lr-backbone / --lr-action-model. "
    ...
    g.add_argument("--lr-backbone", type=float, default=None,
                   help="[Legacy] Backbone LR override. Use --lr-group for new configs.")
    g.add_argument("--lr-action-model", type=float, default=None,
                   help="[Legacy] Action model LR override. Use --lr-group for new configs.")
